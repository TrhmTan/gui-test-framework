...
*   ⭐⭐⭐ **Claude Sonnet / Opus (Bộ óc Tinh nhuệ):**
    ...
    *   **Automation Testing:** Dùng để xử lý các bài toán như lấy element trong Shadow DOM, tương tác iFrame lồng nhau, xử lý bất đồng bộ (Async/await), kéo thả (Drag-and-Drop) hoặc các test case đang chạy chập chọn (Flaky). 
